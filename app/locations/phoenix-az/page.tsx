        ...
        <div className="py-12 px-5 w-full flex flex-col justify-between items-center space-y-8 text-center bg-white">
          ...
          <div className="mx-auto grid justify-center gap-12 sm:grid-cols-2 md:max-w-[80rem] md:grid-cols-3">
            ...
            <ServiceCard
              ...
              link="/locations/phoenix-az/airbnb-cleaning"
            >
              <IconBed className="size-12 text-secondary" />
            </ServiceCard>
            <ServiceCard
            ...
            <ServiceCard
              ...
              link="/locations/phoenix-az/housekeeping-services"
            >
              <IconSprayBottle className="size-12 text-secondary" />
            </ServiceCard>
            <ServiceCard
              title="Residential Cleaning"
              description="Our residential cleaning service covers every room with thorough dusting, sanitization, and surface care. Premium results using eco-friendly products!"
              link="/locations/phoenix-az/residential-cleaning"
            >
              <IconOven className="size-12 text-secondary" />
            </ServiceCard>
          </div>
