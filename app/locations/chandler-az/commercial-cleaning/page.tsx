...
export const metadata = {
  title: "Affordable Commercial Cleaning in Chandler, AZ | Sun Valley Cleaners",
  description:
    "Sun Valley Cleaners provides affordable commercial cleaning in Chandler, AZ with flexible packages, reliable service, and spotless results. Call now!",
  alternates: {
    canonical:
      "https://www.sunvalleycleaners.com/locations/chandler-az/commercial-cleaning",
  },
};

const faqs = [
  {
    question: "What does affordable commercial cleaning in Chandler, AZ include?",
    answer:
      "Affordable commercial cleaning in Chandler, AZ includes offices, retail stores, and medical facilities. Sun Valley Cleaners offers services tailored to your schedule and budget.",
  },
  {
    question: "Why choose Sun Valley Cleaners for commercial cleaning in Chandler, AZ?",
    answer:
  ...
  {
    question: "Do you provide eco-friendly cleaning for commercial spaces in Chandler, AZ?",
    answer:
      "Yes, Sun Valley Cleaners uses eco-friendly products and safe practices in Chandler, AZ to deliver effective results while protecting the environment.",
  },
];
      ...
      <main className="flex min-h-screen flex-col items-center">
        <div className="px-16 md:px-0 py-10 lg:py-20 w-full flex flex-col lg:flex-row items-center md:max-w-[80rem]">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4">
            <h1 className="text-4xl lg:text-6xl text-primary font-black">
              Affordable Commercial Cleaning in Chandler, AZ
            </h1>
            <p className="text-muted-foreground lg:text-lg">
              ...
              provides affordable commercial cleaning in Chandler, AZ. We offer
          ...
          <div className="md:max-w-[80rem] flex flex-col lg:flex-row items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-foreground font-bold">
                Why Choose Sun Valley Cleaners for Commercial Cleaning in Chandler, AZ?
              </h2>
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    <b>Tailored Cleaning Packages:</b> We design service plans to
                    match your property size and cleaning needs, helping you
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    cleaning in Chandler, AZ ensures consistency across every
                    visit. We keep offices, lobbies, and shared spaces clean,
                    helping your business maintain professionalism.
                  </p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="flex-shrink-0 pt-1">
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="commercial cleaning in Chandler office"
        ...
        <div className="px-16 py-10 lg:py-20 w-full items-center bg-card flex flex-col lg:flex-row justify-center">
          <div className="md:max-w-[80rem] flex flex-col-reverse lg:flex-row-reverse items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-foreground font-bold">
                Why Commercial Cleaning Matters in Chandler, AZ
              </h2>
              <p className="text-sm lg:text-lg text-muted-foreground">
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    cleaning in Chandler, AZ reduces dust, bacteria, and
                    allergens in shared spaces. This helps create healthier
                    environments and improves employee satisfaction.
                  </p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="flex-shrink-0 pt-1">
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="commercial cleaning Chandler AZ"
              className="bg-background"
            />
          </div>
        </div>
        ...
        <AlsoAvailableSection
          ...
          areas={[
            ...
            { name: "Gilbert", href: "/locations/gilbert-az/commercial-cleaning" },
