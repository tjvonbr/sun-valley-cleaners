...
export const metadata = {
  title:
    "Top-Rated House Cleaning Service in Paradise Valley, AZ | Sun Valley Cleaners",
  description:
    "Top-rated house cleaning service in Paradise Valley, AZ by Sun Valley Cleaners. Spotless results, reliable service, and guaranteed satisfaction. Call now!",
  alternates: {
      ...
      <main className="flex min-h-screen flex-col items-center">
        <div className="px-16 md:px-0 py-10 lg:py-20 w-full flex flex-col lg:flex-row items-center md:max-w-[80rem]">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4">
            <h1 className="text-4xl lg:text-6xl text-primary font-black">
              Top-Rated House Cleaning Service in Paradise Valley, AZ
            </h1>
              ...
              <div className="flex flex-col items-start space-y-4">
                ...
                <div className="flex items-start w-full">
                  ...
                  <p className="text-lg text-black font-semibold">
                    ...
                    that make our house cleaning service in Paradise Valley, AZ extra
                    effective.
                  </p>
                </div>
              </div>
        ...
        <div className="px-16 py-10 lg:py-20 w-full items-center bg-white flex flex-col lg:flex-row justify-center">
          <div className="md:max-w-[80rem] flex flex-col-reverse lg:flex-row-reverse items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-black font-bold">
                Why House Cleaning Service Matter in Paradise Valley, AZ
              </h2>
              <p className="text-sm lg:text-lg text-slate-400">
            ...
            <div className="max-w-md px-6 mx-auto pb-28 sm:max-w-3xl lg:max-w-7xl lg:px-8">
              <div className="flex flex-col justify-center text-center">
                ...
                <p className="pb-10 mx-auto mt-5 text-xl text-gray-900 max-w-prose">
                  Looking for top-rated house cleaning service in Paradise Valley, AZ?
              ...
              <div className="max-w-4xl mx-auto">
                ...
                >
                  house cleaning service in paradise valley, house cleaning near
                  paradise valley
                </iframe>
              </div>
            </div>
