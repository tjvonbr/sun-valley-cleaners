...
export const metadata = {
  title: "Trusted Move In/Out Cleaning in Arcadia, AZ | Sun Valley Cleaners",
  description:
    "Sun Valley Cleaners delivers trusted move out cleaning in Arcadia, AZ with detailed service, timely results, and stress-free property transitions. Call now!",
  alternates: {
    canonical:
      "https://www.sunvalleycleaners.com/locations/arcadia-az/move-in-move-out-cleaning",
  },
};

const faqs = [
  {
    question: "What does trusted move out cleaning in Arcadia, AZ cover?",
    answer:
      "Trusted move out cleaning in Arcadia, AZ covers all rooms including kitchens, baths, and high-traffic areas. Sun Valley Cleaners ensures every surface is deep cleaned to pass inspection.",
  },
  {
    question: "Why hire a professional for move out cleaning in Arcadia, AZ?",
    answer:
      "Hiring professionals ensures your home is thoroughly cleaned, meeting landlord or buyer expectations. Sun Valley Cleaners provides reliable service tailored to Arcadia properties.",
  },
  {
    question: "When should I schedule move out cleaning in Arcadia, AZ?",
    answer:
      "It’s best to schedule trusted move out cleaning in Arcadia, AZ a few days before your move date. Sun Valley Cleaners offers flexible booking to make the process stress-free.",
  },
];
      ...
      <main className="flex min-h-screen flex-col items-center">
        <div className="px-16 md:px-0 py-10 lg:py-20 w-full flex flex-col lg:flex-row items-center md:max-w-[80rem]">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4">
            <h1 className="text-4xl lg:text-6xl text-primary font-black">
              Trusted Move In/Out Cleaning in Arcadia, AZ
            </h1>
            <p className="text-muted-foreground lg:text-lg">
              ...
              provides trusted move in/out cleaning in Arcadia, AZ. Our team works
          ...
          <div className="md:max-w-[80rem] flex flex-col lg:flex-row items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-foreground font-bold">
                Why Choose Sun Valley Cleaners for Move In/Out Cleaning in Arcadia, AZ?
              </h2>
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    Every detail is handled with care, ensuring your Arcadia
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="move in/out cleaning in Arcadia home"
        ...
        <div className="px-16 py-10 lg:py-20 w-full items-center bg-card flex flex-col lg:flex-row justify-center">
          <div className="md:max-w-[80rem] flex flex-col-reverse lg:flex-row-reverse items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-foreground font-bold">
                Why Move In/Out Cleaning Matters in Arcadia, AZ
              </h2>
              <p className="text-sm lg:text-lg text-muted-foreground">
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    Arcadia, AZ ensures landlords’ cleanliness standards are met,
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    quickly, helping properties in Arcadia stand out in a
                    competitive market.
                  </p>
                </div>
              </div>
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="move in/out cleaning in Arcadia AZ"
              className="bg-background"
            />
          </div>
        </div>
