...
export const metadata = {
  ...
  description:
    "Sun Valley Cleaners offers comprehensive deep cleaning in Arcadia, AZ—detailed care for kitchens, baths, and living areas. Perfect for overhauls. Call now!",
  alternates: {
    canonical:
      "https://www.sunvalleycleaners.com/locations/arcadia-az/deep-cleaning",
  },
};

const faqs = [
  {
    question: "Is deep cleaning in Arcadia, AZ suitable for large homes?",
    answer:
      "Yes, deep cleaning in Arcadia, AZ can be scaled for large homes, ensuring every level and room receives the same detailed attention. Sun Valley Cleaners organizes tasks for efficiency while maintaining consistent quality from top to bottom.",
  },
  {
    question: "When should I plan deep cleaning in Arcadia, AZ around the holidays?",
    answer:
      "Scheduling deep cleaning in Arcadia, AZ a week or two before holidays helps prepare your home for guests, décor, and gatherings. Sun Valley Cleaners coordinates flexible timing to ensure your space is pristine when it matters most.",
  },
  {
    question: "Can deep cleaning in Arcadia, AZ help maintain new renovations?",
    answer:
      "Absolutely, deep cleaning in Arcadia, AZ removes leftover construction dust, adhesive residue, and fine debris from new renovations. Sun Valley Cleaners completes the post-project polish so your upgrades look flawless from the start.",
  },
];
      ...
      <main className="flex min-h-screen flex-col items-center">
        <div className="px-16 md:px-0 py-10 lg:py-20 w-full flex flex-col lg:flex-row items-center md:max-w-[80rem]">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4">
            <h1 className="text-4xl lg:text-6xl text-primary font-black">
              Comprehensive Deep Cleaning in Arcadia, AZ
            </h1>
            <p className="text-muted-foreground lg:text-lg">
              ...
              delivers comprehensive deep cleaning in Arcadia, AZ—covering every
        ...
        <div className="px-16 py-10 lg:py-20 w-full items-center bg-card flex flex-col lg:flex-row justify-center">
          <div className="md:max-w-[80rem] flex flex-col lg:flex-row items-center">
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    <b>Full-Room Detailing:</b> Our deep cleaning in Arcadia covers
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    <b>Seasonal Deep Reset:</b> Arcadia&apos;s desert dust can build up
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    <a
                      href="https://en.wikipedia.org/wiki/Arcadia_(Phoenix)"
                      target="_blank"
                      className="underline text-secondary"
                    >
                      Arcadia, AZ
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="deep cleaning in Arcadia home"
        ...
        <div className="px-16 py-10 lg:py-20 w-full items-center bg-card flex flex-col lg:flex-row justify-center">
          <div className="md:max-w-[80rem] flex flex-col-reverse lg:flex-row-reverse items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4 ">
              <h2 className="text-3xl lg:text-5xl text-foreground font-bold">
                Why Deep Cleaning Services Matter in Arcadia, AZ
              </h2>
              <p className="text-sm lg:text-lg text-muted-foreground">
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    cleaning in Arcadia removes sawdust, adhesive residue, and fine
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    Arcadia slows wear on tile, grout, and high-use surfaces,
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-lg text-foreground font-semibold">
                    ...
                    mites, and hidden buildup, deep cleaning in Arcadia supports a
            ...
            <Image
              ...
              height="750"
              width="500"
              alt="deep house cleaning in Arcadia AZ"
              className="bg-background"
            />
          </div>
        </div>
