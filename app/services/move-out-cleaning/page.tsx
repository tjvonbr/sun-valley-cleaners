...
export const metadata = {
  title: "Move-Out Cleaning Service in Scottsdale, AZ | Sun Valley Cleaners",
  description:
    "Professional move-out cleaning in Scottsdale, AZ. Inside cabinets, appliances, baseboards and baths cleaned before day one. Free estimate, no surprises.",
  alternates: {
    canonical: "https://www.sunvalleycleaners.com/services/move-out-cleaning",
  },
};
