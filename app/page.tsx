...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div className="px-16 py-12 w-full flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 bg-secondary text-white">
        <CommitmentCard
          title="100% Guarantee"
      ...
      <div className="px-16 py-10 lg:py-20 w-full flex flex-col lg:flex-row items-center bg-white">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-start space-y-4">
          <h2 className="text-3xl lg:text-5xl text-black font-bold">
            Commited to quality and customer satisfaction
          </h2>
          <p className="text-sm lg:text-lg text-slate-400">
            We provide a range of services to meet each of your house cleaning
            needs. Whatever problem you&apos;re facing, we have a solution!
          </p>
